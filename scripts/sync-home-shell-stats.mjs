 ...
 *
 * Hero / countable vacancy totals only sum jobs with vacancies > 0
 * (zero-vacancy listings still count toward notification totals).
 */
...
const withVac = countable.length
const orgs = new Set(
