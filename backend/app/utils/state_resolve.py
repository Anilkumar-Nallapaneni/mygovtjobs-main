...
_NAME_TO_CODE: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"\bjammu\b|\bkashmir\b|\bjkpsc\b", re.I), "jk"),
    (re.compile(r"\bladakh\b", re.I), "la"),
    (re.compile(r"\bpuducherry\b|\bpondicherry\b", re.I), "py"),
    (re.compile(r"\bandaman\b|\bnicobar\b", re.I), "an"),
    (re.compile(r"\blakshadweep\b", re.I), "ld"),
    (re.compile(r"\bdadra\b|\bdaman\b|\bdiu\b", re.I), "dd"),
    (re.compile(r"\bncrtc\b|\bnational capital region", re.I), "dl"),
    (re.compile(r"\bhssc\b|\bharyana\b", re.I), "hr"),
    (re.compile(r"\bgoa\b", re.I), "ga"),
]
