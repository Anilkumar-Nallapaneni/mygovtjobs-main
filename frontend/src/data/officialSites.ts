...
export const OFFICIAL_SITES = [
  ...
  { id: "rrb-bbs",       name: "Railway Recruitment Board (RRB) — Bhubaneswar", ...u("https://www.rrbbbs.gov.in/", "https://www.rrbbbs.gov.in/notifications.php"),                            scope: "central", category: "railways", stateIds: ["all"] },
