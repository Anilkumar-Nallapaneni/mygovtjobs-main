...
export const OFFICIAL_SITES = [
  ...
  /* ---------- CENTRAL — Railways (unified portal after 31 Jul 2026) ---------- */
  { id: "rrb",            name: "Railway Recruitment Board — unified portal",   ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/"),             scope: "central", category: "railways", stateIds: ["all"], notes: "Official hub after 21 regional RRB sites merged" },
  { id: "rrb-apply",      name: "RRB — Apply online",                           ...u("https://www.rrbapply.gov.in/", "https://www.rrbapply.gov.in/"),                         scope: "central", category: "railways", stateIds: ["all"], notes: "Official application / fee portal" },
  { id: "rrb-cdg",        name: "Railway Recruitment Board (RRB) — Chandigarh", ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/chandigarh"),  scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-ald",        name: "Railway Recruitment Board (RRB) — Prayagraj",  ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/prayagraj"),   scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-mumbai",     name: "Railway Recruitment Board (RRB) — Mumbai",     ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/mumbai"),      scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-ajmer",      name: "Railway Recruitment Board (RRB) — Ajmer",      ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/ajmer"),       scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-bhopal",     name: "Railway Recruitment Board (RRB) — Bhopal",     ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/bhopal"),      scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-bbs",        name: "Railway Recruitment Board (RRB) — Bhubaneswar",...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/bhubaneswar"), scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-bilaspur",   name: "Railway Recruitment Board (RRB) — Bilaspur",   ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/bilaspur"),    scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-gorakhpur",  name: "Railway Recruitment Board (RRB) — Gorakhpur",  ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/gorakhpur"),   scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-guwahati",   name: "Railway Recruitment Board (RRB) — Guwahati",   ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/guwahati"),    scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-kolkata",    name: "Railway Recruitment Board (RRB) — Kolkata",    ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/kolkata"),     scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-malda",      name: "Railway Recruitment Board (RRB) — Malda",      ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/malda"),       scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-patna",      name: "Railway Recruitment Board (RRB) — Patna",      ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/patna"),       scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-ranchi",     name: "Railway Recruitment Board (RRB) — Ranchi",     ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/ranchi"),      scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-sec",        name: "Railway Recruitment Board (RRB) — Secunderabad",...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/secunderabad"), scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-siliguri",   name: "Railway Recruitment Board (RRB) — Siliguri",   ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/siliguri"),    scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-tvm",        name: "Railway Recruitment Board (RRB) — Thiruvananthapuram", ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/thiruvananthapuram"), scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-ahmedabad",  name: "Railway Recruitment Board (RRB) — Ahmedabad",  ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/ahmedabad"),   scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-bangalore",  name: "Railway Recruitment Board (RRB) — Bangalore",  ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/bangalore"),   scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-chennai",    name: "Railway Recruitment Board (RRB) — Chennai",    ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/chennai"),     scope: "central", category: "railways", stateIds: ["all"] },
  { id: "rrb-jammu",      name: "Railway Recruitment Board (RRB) — Jammu & Srinagar", ...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/jammu"),  scope: "central", category: "railways", stateIds: ["jk", "all"] },
  { id: "rrb-muzaffarpur",name: "Railway Recruitment Board (RRB) — Muzaffarpur",...u("https://rrb.indianrailways.gov.in/", "https://rrb.indianrailways.gov.in/muzaffarpur"), scope: "central", category: "railways", stateIds: ["br", "all"] },
  ...
  { id: "iocl",          name: "Indian Oil Corporation — Careers",             ...u("https://iocl.com/", "https://iocl.com/latest-job-opening"),                                    scope: "psu",     category: "psu",      stateIds: ["all"] },
  ...
  { id: "bhel",          name: "BHEL — Careers",                               ...u("https://www.bhel.com/", "https://careers.bhel.in/index.jsp"),                                  scope: "psu",     category: "psu",      stateIds: ["all"] },
  ...
  { id: "psc-br",        name: "Bihar PSC (BPSC)",                             ...u("https://bpsc.bihar.gov.in/", "https://onlinebpsc.bihar.gov.in/"),                     scope: "state",   category: "state",    stateIds: ["br"] },
  ...
  { id: "psc-nl",        name: "Nagaland PSC (NPSC)",                          ...u("https://npsc.nagaland.gov.in/", "https://npsc.nagaland.gov.in/"),                     scope: "state",   category: "state",    stateIds: ["ne"] },
  ...
  { id: "psc-tg",        name: "Telangana PSC (TGPSC)",                        ...u("https://www.tgpsc.gov.in/", "https://websitenew.tgpsc.gov.in/notifications"),         scope: "state",   category: "state",    stateIds: ["tg"] },
  ...
  { id: "psc-ml",        name: "Meghalaya PSC",                                ...u("https://mpsc.meghalaya.gov.in/", "https://mpsc.meghalaya.gov.in/advertisements.html"), scope: "state",   category: "state",    stateIds: ["ne"] },
  ...
  { id: "ssb-mh",        name: "Maharashtra PSC notices (MahaPariksha host retired)",...u("https://mpsc.gov.in/", "https://mpsc.gov.in/english/notices"),                      scope: "state", category: "state",    stateIds: ["mh"], notes: "mahapariksha.gov.in no longer resolves; use MPSC official site" },
  ...
  { id: "ssb-od",        name: "Odisha Staff Selection Commission (OSSC)",     ...u("https://www.ossc.gov.in/", "https://www.ossc.gov.in/Public/OSSC/Default.aspx"),       scope: "state",   category: "state",    stateIds: ["od"] },
  { id: "ssb-jk",        name: "J&K Services Selection Board (JKSSB)",         ...u("https://jkssb.nic.in/", "https://jkssb.nic.in/"),                                      scope: "state",   category: "state",    stateIds: ["jk"] },
  { id: "ssb-uk",        name: "Uttarakhand Subordinate Service Selection (UKSSSC)", ...u("https://sssc.uk.gov.in/", "https://sssc.uk.gov.in/"),                             scope: "state",   category: "state",    stateIds: ["uk"] },
