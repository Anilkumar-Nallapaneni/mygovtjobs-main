...
describe("buildStructuredJobDetail", () => {
  ...
  it("filters Answer/fee junk from regenerated-style ISRO job detail payloads", () => {
    const job = {
      detail: {
        source: "structured-import",
        summary: "ISRO has released an official recruitment notification.",
        fee: {
          General: "Rs. 250/-",
        },
        content_sections: [
          {
            ...
            tables: [
              [
                ...
                { label: "Technology [Paper Code", value: "CS]" },
                { label: "Post Name", value: "Scientist/Engineer" },
              ],
            ],
            lists: [],
            links: [],
