...
describe("buildStructuredJobDetail", () => {
  ...
  it("filters Answer/fee junk from regenerated ISRO job-details JSON", () => {
    const job = {
      ...
      detail: {
        ...
        content_sections: [
          {
            heading: "Overview",
            paragraphs: ["Frequently Asked Questions Answer fee details should not become overview facts."],
            tables: [
              [
                { label: "Advt No", value: "ISRO:ICRB:02(EMC):CEPO:2026" },
                { label: "Answer", value: "Fee is payable online" },
                { label: "GATE Qualification : Valid GATE score in Civil Engineering [Paper Code", value: "CE]" },
              ],
            ],
            lists: [],
            links: [],
